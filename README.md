...
Business Intelligence professional focused on:
- Executive dashboards
- KPI storytelling
- DAX optimization
- Dark-theme reporting

<a id="versi-bahasa-indonesia"></a>

## 📊 Visualisasi Data Power BI

Profesional Business Intelligence yang berfokus pada:
- Dashboard eksekutif
- Storytelling KPI
- Optimasi DAX
- Laporan dengan tema gelap
